...
/*
 * Example sketch to take measurements of an automatic point-dendrometer, 
 * a thermocouple "Granier-sap-flow" sensor and a DS18S20 temperature sensor. 
 * 
...
void measure() {
  ...
  if (Filesize == 0 && dataFile) {
    dataFile.println("Date,dd1,xyl1,temp,battV");         // if File is empty (new), create header
  } else { 
  }
  if (dataFile) {
