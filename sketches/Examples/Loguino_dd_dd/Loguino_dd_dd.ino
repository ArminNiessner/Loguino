...
void measure() {
  ...
  digitalWrite(enable_dd2, HIGH);         // enable voltage supply to Dendrometer #2
  ...
  if (Filesize == 0 && dataFile) {
    dataFile.println("Date,dd1,dd2,battV");         // if File is empty (new), create header
  } else { 
  }
  if (dataFile) {
